...
class Management
{
     ...
     */
    public function addCate(string $title, string $body): void
    {
     ...
     * @param int $id
     */
    public function deleteCate(int $id): void
    {
     ...
     * @param int $id
     */
    public function getCate(int $id): void
    {
     ...
     * @param int $postId
     */
    public function updateCate(string $title, string $body,  int $postId): void
    {
